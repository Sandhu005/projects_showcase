...
(function () {
  ...
  onReady(function () {
    ...
    // Initialize user profile values in UI. Provide a window.user object to override defaults.
    function initUserProfile() {
      var user = window.user || { name: "Guest", workspace: "Active Workspace", avatar: "../images/avatar/avatar.jpg" };
